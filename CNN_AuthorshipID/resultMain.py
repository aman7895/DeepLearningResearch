...
# set parameters:
def myfunc(authorlist , doc_id, tdoc, lang):
    subset = None
    ...
    ((trainX, trainY), (valX, valY)) = data_helpers.load_ag_data(authors = authorlist, docID = doc_id, tdoc = tdoc, lang = lang)
    ...
    for e in xrange(nb_epoch):
        ...
        e_elap = stop - start
        t_elap = stop - initial
        print('Epoch {}. Loss: {}. Accuracy: {}\nEpoch time: {}. Total time: {}\n'.format(e, test_loss_avg,
                                                                                          test_accuracy_avg, e_elap, t_elap))
    ...
    (testX, testY) = data_helpers.load_doc_data(authors = authorlist, docID = doc_id, lang = lang)
    ...
    return (test_binary, test_binary2)
